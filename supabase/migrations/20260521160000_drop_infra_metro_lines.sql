-- infra_metro_lines unused; metro stations keep denormalized line_id text.
...
ALTER TABLE public.infra_metro_stations
  DROP CONSTRAINT IF EXISTS infra_metro_stations_line_id_fkey;

DROP TABLE IF EXISTS public.infra_metro_lines;
