...
export function StatisticsPage(): JSX.Element {
  ...
  return (
    <div dir="rtl" className="min-h-0 flex-1 overflow-y-auto bg-bg-1">
      ...
      <div className="relative mx-auto flex max-w-[1440px] flex-col gap-4 p-4 lg:p-5">
        <header className="overflow-hidden rounded-lg border border-border bg-surface p-5 shadow-card ring-1 ring-white/[0.03]">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="text-2xl font-bold tracking-tight text-text md:text-[32px]">
